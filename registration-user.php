...
if (isset($_POST["signup"])) {
  ...
  $mobile_number = mysqli_real_escape_string($conn, $_POST["signup_mobile_number"]);
  ...
  if ($password !== $cpassword) {
    ...
    $sql = "INSERT INTO users (full_name, mobile_number, address, email, password, token, status) VALUES ('$full_name', '$mobile_number', '$address', '$email', '$password', '$token', '0')";
    $result = mysqli_query($conn, $sql);
    if ($result) {
      $_POST["signup_full_name"] = "";
      $_POST["signup_mobile_number"] = "";
      ...
      $to = $email;
      $subject = "Email verification - Raj Textiles and Engineers";
...
<head>
  ...
  <title> Raj Textiles and Engineers | Sign in & Sign up </title>
    ...
    <div class="forms-container">
      <div class="signin-signup">
        <form action="" method="post" class="sign-in-form">
          <h1 class="title">Raj Textiles and Engineers</h1>
          ...
          <div>
          <a href="forgot-password.php" style="justify-content:center;color: #4481eb; font-size: 0.9rem">Forgot Password?</a></p>
          </div>
        ...
        <form action="" class="sign-up-form" method="post">
          ...
          <div class="input-field">
            ...
            <input type="tel" placeholder="Mobile Number" name="signup_mobile_number" value="<?php echo $_POST["signup_mobile_number"]; ?>" required />
          </div>
          <div class="input-field">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3>New here?</h3>
          <p>
            Create an account to access our product and services.
          </p>
      ...
      <div class="panel right-panel">
        <div class="content">
          <h3>One of us?</h3>
          <p>
            Login to access our products and services.
          </p>
