...
if (isset($_POST["resetPassword"])) {
  ...
  if (mysqli_num_rows($check_email) > 0) {
    ...
    $to = $email;
    $subject = "Reset Password - Raj Textiles and Engineers";
...
<head>
  ...
  <title> Raj Textiles and Engineers | Forgot Password </title>
    ...
    <div class="forms-container">
      <div class="signin-signup">
        <form action="" method="post" class="sign-in-form">
          ...
          <input type="submit" value="Verify" name="resetPassword" class="btn solid" />
        </form>
      </div>
    </div>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <p>
            Enter your email address to recive verification link.
          </p>
        </div>
        <img src="img/forgotpass.png" class="image" alt="" />
      </div>
    </div>
  </div>
